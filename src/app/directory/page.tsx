...
export default function DirectoryPage() {
  ...
  const copy: Record<string, {
    ...
    de: {
      ...
      sub: "Durchsuche unser Verzeichnis verifizierter Fachpersonen in Europa",
      ...
      emptyDesc: "Pass deine Suche an oder setz Filter zurück, um mehr Ergebnisse zu sehen.",
      mapAria: "Kartenplatzhalter", mapBadge: "google",
      viewBtn: "Ansehen",
      messageBtn: "Nachricht",
      alertTitle: "OmniCheck",
      alertDesc: "Nicht sicher, wo du beginnen sollst? Erhalte sofortige Einblicke und Vorschläge.",
      alertOpen: "Öffnen",
